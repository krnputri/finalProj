...
class TestNas(unittest.TestCase): 
    ...
    def test_addNas(self): 
        ...
        # ADD
        browser.get("https://opensource-demo.orangehrmlive.com/index.php/admin/viewJobTitleList")
        browser.find_element(By.ID,"btnAdd").click()
        browser.find_element(By.ID, "jobTitle_jobTitle").send_keys("Manager I")
        browser.find_element(By.ID, "jobTitle_jobDescription").send_keys("Bertugas sebagai manajer pertama")
